...
export function createAccessTokenRequest(access_code: string): AuthTokenPromisse {
...
export function createRefreshTokenRequest(refresh_token: string): AuthTokenPromisse {
  return baseAccessTokenRequest({
...
export function baseAccessTokenRequest(config: Record<string, string>): AuthTokenPromisse{
